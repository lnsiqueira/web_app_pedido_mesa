...
class NfceService {
  Future<bool> getInformacoesFiscaisDosProdutosNaoGeraNFe(
    dynamic pedido,
    ...
    try {
      ...
      for (var item in itensCarrinho) {
        ...
        if (response.statusCode == 200) {
          ...
          double precoItem = item.produto.preco?.toDouble() ??
              produtoFiscal['preco']?.toDouble() ??
              0.0;
          ...
          listaProdutos.add(
            Produto(
              ...
              imposto: nfeModel.Imposto(
                ...
                pis: nfeModel.PIS(
                  cst: produtoFiscal['cstpis']?.toString().padLeft(2, '0') ??
                      '99',
                ...
                cofins: nfeModel.COFINS(
                  cst: produtoFiscal['cstcofins']?.toString().padLeft(2, '0') ??
                      '99',
                  vBC: resultado.baseCompra,
...
//nao gera o numero da nota e analisa as urls
